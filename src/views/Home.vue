<script setup>
    ...
    const getTableData = async () => {
        const data = await proxy.$api.getHomeTableData();
    ...
    <el-row class="home" :gutter="20">
        <el-col :span="8" style="margin-top: 20px">
            <el-card shadow="hover">
                <div class="user">
                    <img :src="getUserImgUrl('user')" class="user" />
                    <div class="user-info">
                ...
                <div class="login-info">
                    <p>上次登录时间:<span>2021-09-01</span></p>
                    <p>上次登陆地址:<span>湖南</span></p>
                </div>
            </el-card>
